...
@user.roles = [:affair, :location, :independent_carousel, :product, :merchant_image, :merchant_basic, :hot_word, :product_home, :guest, :product_group, :product_bargain, :product_limit]
@user.save
