...
@user.roles = [:affair, :location, :independent_carousel, :product, :merchant_image, :merchant_basic, :hot_word, :product_recommend, :guest, :product_group, :product_bargain, :product_limit, :recharge_card]
@user.save
