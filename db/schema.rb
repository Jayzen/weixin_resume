...
ActiveRecord::Schema.define(version: 2019_08_31_080901) do
  ...
  create_table "affair_likes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "guest_id"
    t.integer "affair_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["affair_id"], name: "index_affair_likes_on_affair_id"
  ...
  create_table "guest_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "guest_id"
    t.string "name"
    t.string "mobile"
    t.string "province"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["guest_id"], name: "index_guest_addresses_on_guest_id"
  end
  ...
  create_table "pay_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["guest_id"], name: "index_pay_records_on_guest_id"
    t.index ["user_id"], name: "index_pay_records_on_user_id"
  end
  ...
  create_table "product_keeps", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "guest_id"
    t.integer "product_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["guest_id"], name: "index_product_keeps_on_guest_id"
    t.index ["product_id"], name: "index_product_keeps_on_product_id"
  end
  ...
  create_table "product_recommends", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.integer "product_id"
    t.integer "order"
    t.boolean "reveal"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_product_recommends_on_product_id"
  ...
  create_table "recharge_resumes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "guest_id"
    t.decimal "recharge", precision: 5, scale: 2
    t.integer "from", default: 0
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["guest_id"], name: "index_recharge_resumes_on_guest_id"
  end
  ...
  create_table "user_guests", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.integer "guest_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["guest_id"], name: "index_user_guests_on_guest_id"
    t.index ["user_id", "guest_id"], name: "index_user_guests_on_user_id_and_guest_id", unique: true
